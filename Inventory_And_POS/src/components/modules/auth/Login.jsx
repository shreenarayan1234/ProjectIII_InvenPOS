          ...
          <div className={`card ${style.card}`}>
            ...
            <div className="card-body">
              <label className="w-100">
                ...
                />
                <p className={style.login_error_msg}><small>{errors.email != undefined ? errors.email[0]:null}</small></p>
              </label>
              <label className="w-100 mt-4">
                ...
                <input
                  ...
                  onChange={handleInput}
                />
                <p className={style.login_error_msg}><small>{errors.password != undefined ? errors.password[0]:null}</small></p>
              </label>
              <div className="d-grid mt-4">
                <button onClick={handleLogin} className="btn btn-success" dangerouslySetInnerHTML={{ __html:isLoading ? '<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> Login...' : 'Login' }}/>
              </div>
            </div>
          </div>
        </div>
